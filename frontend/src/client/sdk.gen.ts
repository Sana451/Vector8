...
export class FuelService {
     ...
     */
    public static importPumppriceFuel<ThrowOnError extends boolean = true>(options: Options<fuelImportPumppriceFuelData, ThrowOnError>) {
        return (options.client ?? client).post<fuelImportPumppriceFuelResponses, fuelImportPumppriceFuelErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
...
export class GeocodingService {
     ...
     */
    public static search<ThrowOnError extends boolean = true>(options: Options<geocodingSearchData, ThrowOnError>) {
        return (options.client ?? client).post<geocodingSearchResponses, geocodingSearchErrors, ThrowOnError>({
            responseType: 'json',
